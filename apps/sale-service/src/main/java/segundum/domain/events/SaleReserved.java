...
/**
 * Represents a domain event raised when a sale is reserved by the seller.
 */
public class SaleReserved extends DomainEvent implements SaleEvent {
    ...
    /**
     * Constructs a new SaleReserved event.
     *
     * @param saleId    the identifier of the sale
     * @param productId the identifier of the product
     */
    public SaleReserved(SaleId saleId, ProductId productId) {
        super();
        this.saleId = saleId;
