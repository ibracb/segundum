...
/**
 * Represents a domain event raised when a sale is cancelled by the purchaser.
 */
public class SaleCancelledByPurchaser extends DomainEvent implements SaleEvent {
    ...
    /**
     * Constructs a new SaleCancelledByPurchaser event.
     *
     * @param saleId    the identifier of the sale
     * @param productId the identifier of the product
     */
    public SaleCancelledByPurchaser(SaleId saleId, ProductId productId) {
        super();
        this.saleId = saleId;
