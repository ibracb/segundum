...
/**
 * Represents the request to reject a sale.
 */
@Schema(description = "Request to reject a sale")
public class RejectSaleRequest {
    ...
    /**
     * Constructs a new empty RejectSaleRequest for deserialization.
     */
    public RejectSaleRequest() {
    }
