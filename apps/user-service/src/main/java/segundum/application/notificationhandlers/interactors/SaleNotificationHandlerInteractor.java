...
public class SaleNotificationHandlerInteractor implements SaleNotificationHandler {
	 ...
	 */
	public SaleNotificationHandlerInteractor(UserRepository userRepository, LogEmitter logEmitter) {
	 ...
	 */
	private void incrementPurchases(SaleCompletedNotification event) {
		try {
	 ...
	 * @param event the sale completed event
	 */
	private void incrementSales(SaleCompletedNotification event) {
		try {
