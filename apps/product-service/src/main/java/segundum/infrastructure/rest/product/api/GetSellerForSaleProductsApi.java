...
/**
 * Represents the REST API for retrieving the products on sale of a seller.
 */
@Tag(name = "Products", description = "Product management endpoints")
@RequestMapping("/sellers")
public interface GetSellerForSaleProductsApi {

	@Operation(summary = "Get seller for-sale products", description = "Returns all products on sale for a given seller")
	@ApiResponses(value = {
