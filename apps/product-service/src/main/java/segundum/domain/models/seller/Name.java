...
import segundum.domain.exceptions.seller.name.NameBlankException;
import segundum.domain.exceptions.seller.name.NameInvalidFormatException;
import segundum.domain.exceptions.seller.name.NameNullException;

/**
 * Represents a seller's name.
 * This is a replica of the user name from the user microservice, received via domain events.
 */
public class Name {
